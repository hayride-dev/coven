# <a id="imports"></a>World imports
 ...
 - Imports:
    ...
    - interface `hayride:ai/tensor-stream@0.0.38`
    - interface `wasi:nn/errors@0.2.0-rc-2024-10-28`
    - interface `hayride:ai/inference-stream@0.0.38`
    - interface `hayride:ai/graph-stream@0.0.38`
    - interface `hayride:ai/types@0.0.38`
    - interface `hayride:ai/model@0.0.38`
    - interface `hayride:ai/agent@0.0.38`
    - interface `hayride:ai/transformer@0.0.38`
    - interface `hayride:ai/rag@0.0.38`
...
## <a id="hayride_ai_tensor_stream_0_0_38"></a>Import interface hayride:ai/tensor-stream@0.0.38
...
## <a id="hayride_ai_inference_stream_0_0_38"></a>Import interface hayride:ai/inference-stream@0.0.38
...
## <a id="hayride_ai_graph_stream_0_0_38"></a>Import interface hayride:ai/graph-stream@0.0.38
...
## <a id="hayride_ai_types_0_0_38"></a>Import interface hayride:ai/types@0.0.38
...
## <a id="hayride_ai_model_0_0_38"></a>Import interface hayride:ai/model@0.0.38
...
## <a id="hayride_ai_agent_0_0_38"></a>Import interface hayride:ai/agent@0.0.38
...
- <a id="invoke.output"></a>`output`: own<[`output-stream`](#output_stream)>

##### Return values

- <a id="invoke.0"></a> result<_, own<[`error`](#error)>>

## <a id="hayride_ai_transformer_0_0_38"></a>Import interface hayride:ai/transformer@0.0.38
...
## <a id="hayride_ai_rag_0_0_38"></a>Import interface hayride:ai/rag@0.0.38
