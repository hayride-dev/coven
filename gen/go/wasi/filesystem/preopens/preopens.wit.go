...
// Package preopens represents the imported interface "wasi:filesystem/preopens@0.2.2".
package preopens

import (
	"github.com/bytecodealliance/wasm-tools-go/cm"
	"github.com/hayride-dev/bindgen/gen/go/wasi/filesystem/types"
)
...
//go:wasmimport wasi:filesystem/preopens@0.2.2 get-directories
//go:noescape
